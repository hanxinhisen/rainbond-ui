...
const componentOverview = {
    ...
    'componentOverview.body.PythonCNBConfig.requirements_file': 'Requirements 文件',
    'componentOverview.body.PythonCNBConfig.requirements_file_tip': '指定 pip 安装使用的 requirements 文件路径',
    'componentOverview.body.PythonCNBConfig.pip_dest_path': '依赖目录',
    'componentOverview.body.PythonCNBConfig.pip_dest_path_tip': '指定 pip vendor 依赖目录',
    'componentOverview.body.PythonCNBConfig.private_index_url': '私服地址',
    'componentOverview.body.PythonCNBConfig.private_index_url_tip': '指定 pip / pipenv 使用的主私服索引地址',
    'componentOverview.body.PythonCNBConfig.extra_index_url': '额外索引',
    'componentOverview.body.PythonCNBConfig.extra_index_url_tip': '指定 pip / pipenv 的额外索引地址',
